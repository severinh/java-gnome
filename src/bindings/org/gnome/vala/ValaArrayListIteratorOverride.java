...
final class ValaArrayListIteratorOverride extends Plumbing
{
    private ValaArrayListIteratorOverride() {}

    static final <T extends Proxy> boolean next(Iterator<T> self) {
        boolean result;
    ...
    static final <T extends Proxy> T get(Iterator<T> self) {
        long result;

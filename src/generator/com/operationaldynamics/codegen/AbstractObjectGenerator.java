 ...
 * @author Andrew Cowie
 */
public abstract class AbstractObjectGenerator extends TypeGenerator
{
    protected Thing parentType;

    protected Thing[] implementedTypes;

    public AbstractObjectGenerator(DefsFile data, String parentGType, String[] implementedGInterfaces) {
        super(data);
        if (parentGType == null) {
            parentType = Thing.lookup(getDefaultParentGType());
        } else {
    ...
    protected abstract String getDefaultParentGType();
